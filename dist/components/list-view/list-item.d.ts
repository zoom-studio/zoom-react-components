...
export declare const ListViewItem: <ContentType = unknown>({ hover, badgeHolderGutter, badgeHolderGutterReversed, actions, avatars, badge, checkbox, content, description, image, radioButton, switcher, title, contextMenu, children, actionsProps, link, avatarProps, badgeProps, imageProps, linkComponent, index, itemsProps, onClick, emoji, icon, }: ListViewItemNS.Props<ContentType>) => JSX.Element;
